    ...
    const btpRegionCode = (await Enquirer.prompt<{ selection: string }>({
        ...
        choices:
            [
                ...
                { "name": "eu10-001", "message": "eu10-001 - Europe (Frankfurt)", "hint": "Amazon Web Services" },
                { "name": "eu10-002", "message": "eu10-002 - Europe (Frankfurt)", "hint": "Amazon Web Services" },
                { "name": "eu10-003", "message": "eu10-003 - Europe (Frankfurt)", "hint": "Amazon Web Services" },
                ...
                { "name": "eu20-001", "message": "eu20-001 - Europe (Netherlands)", "hint": "Microsoft Azure" },
                ...
                { "name": "us10-001", "message": "us10-001 - US East (VA)", "hint": "Amazon Web Services" },
                { "name": "us10-002", "message": "us10-002 - US East (VA)", "hint": "Amazon Web Services" },
